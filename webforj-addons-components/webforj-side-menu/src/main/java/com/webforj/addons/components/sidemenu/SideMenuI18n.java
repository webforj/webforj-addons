...
public class SideMenuI18n {
	...
	/**
	 * The text displayed when no items are found in the items section after a
	 * search in {@link SideMenu}.
	 */
	private String noItemFound = "No items found";

	/**
	 * The text displayed when no favorite items are found in the favorites section
	 * after a search in {@link SideMenu}.
	 */
