...
/**
 * Represents a group of properties within a schema, designed for display in a {@link
 * PropertiesPanel}. {@code SchemaGroup} organizes related properties together, facilitating
 * structured and organized presentation. It supports collapsible and expandable behavior for
 * efficient use of space.
 *
 * <p>Allows heterogeneous property types (any subclass of {@link BaseSchema}) in the same group.
 *
 * @author ElyasSalar
 * @since 1.00
 */
public class SchemaGroup {
   ...
   * @return The {@code BaseSchema} object with the specified label, or {@code null} if not found.
   */
   ...
   * @return {@code true} if the property is present in the group, {@code false} otherwise.
   */
