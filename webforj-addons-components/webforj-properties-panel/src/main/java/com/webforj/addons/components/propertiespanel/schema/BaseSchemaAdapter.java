...
/**
 * A custom Gson adapter for serializing and deserializing instances of {@link BaseSchema}. This
 * adapter handles the polymorphic nature of {@link BaseSchema} by determining the correct concrete
 * subclass based on the {@code type} field present in the JSON representation.
 *
 * <p>The supported schema types are:
 *
 * <ul>
 *   <li>string - maps to {@link StringSchema}
 *   <li>number - maps to {@link NumberSchema}
 *   <li>enum - maps to {@link EnumSchema}
 *   <li>boolean - maps to {@link BooleanSchema}
 * </ul>
 */
public class BaseSchemaAdapter
  ...
  /**
   * Deserializes the JSON element into an appropriate subclass of {@link BaseSchema} based on the
   * {@code type} field.
   *
  ...
  /**
   * Serializes the {@link BaseSchema} object into its JSON representation. The correct subclass is
   * determined by the {@link BaseSchema#getType()} method.
   *
  ...
  public JsonElement serialize(
      BaseSchema<?> src, Type typeOfSrc, JsonSerializationContext context) {
