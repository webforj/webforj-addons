 ...
 *
 * <p>
 * The {@code Suggestion} class defines the properties of each suggestion that
 * can be shown in the SuggestionEdit component. Each suggestion has a
 * {@code value} and an {@code id}, and may have additional properties for
 * display and behavior customization.
 * </p>
 *
 * <p>
 * Instances of this class are used in the list of suggestions that the
 * {@link SuggestionEdit} component displays based on user input.
 * </p>
 *
 * @since 1.00
 * @author ElyasSalar
...
public class Suggestion {
	...
	/**
	 * The id of the suggestion. This is the actual identifier that will be used to
	 * identify a suggestion.
	 */
	private String id;

	/**
	 * The value of the suggestion. This is the text that will be displayed to the
	 * user in the suggestion list.
	 */
	private String value;

	/**
	 * The prefix of the suggestion. This can be used to set any prefix for certain
	 * suggestions like text, signs, icons, and images. It supports HTML strings.
	 */
	private String prefix;

	/**
	 * The suffix of the suggestion. This can be used to set any suffix for certain
	 * suggestions like text, signs, icons, and images. It supports HTML strings.
	 */
	private String suffix;

	/**
	 * Indicates whether this suggestion is disabled. Disabled suggestions cannot be
	 * selected.
	 */
	private boolean disabled;

	/**
	 * Constructs a new Suggestion with the specified {@code id}, {@code value},
	 * {@code prefix}, {@code suffix}, and {@code disabled} state.
	 *
	...
	/**
	 * Constructs a new Suggestion with the specified {@code id}, {@code value}, and
	 * {@code disabled} state.
	 *
	 * @param id The id of the suggestion.
	 * @param value The value of the suggestion.
	 ...
	 *
	 * @param disabled {@code true} if the suggestion should be disabled,
