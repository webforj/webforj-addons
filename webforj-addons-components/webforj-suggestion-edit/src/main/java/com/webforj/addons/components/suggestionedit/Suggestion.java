 ...
 *
 * <p>
 * The {@code Suggestion} class defines the properties of each suggestion that can be shown in the
 * SuggestionEdit component. Each suggestion has a {@code value} and an {@code id}, and may have
 * additional properties for display and behavior customization.
 * </p>
 *
 * <p>
 * Instances of this class are used in the list of suggestions that the {@link SuggestionEdit}
