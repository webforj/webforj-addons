...
/**
 * Event representing the change in value of the SuggestionEdit field to a
 * suggestion.
 *
 * <p>
 * The {@code ChangedEvent} is emitted when the value of the component changes
 * to a suggestion. This change can occur either by clicking on a suggestion in
 * the dropdown or by pressing the Enter key on a suggestion.
 * </p>
 *
 * @since 1.00
 * @author ElyasSalar
