...
/**
 * Represents a slightly-modified AuthenticatorAttestationResponse to simplify
 * working with ArrayBuffers that are Base64URL-encoded in the browser.
 *
 * @see <a href=
 *      "https://www.w3.org/TR/webauthn-3/#iface-authenticatorattestationresponse">
 *      5.2.1. Information About Public Key Credential</a>
 *
 * @author @ElyasSalar
 * @since 1.00
 */
public class AuthenticatorAttestationResponse {
	/**
	 * Contains the JSON-compatible serialization of client data passed to the
	 * authenticator by the client in order to generate this credential. The exact
	 * JSON serialization MUST be preserved, as the hash of the serialized client
	 * data has been computed over it.
	 */
	private String clientDataJSON;

	/**
	 * Contains an attestation object, which is opaque to, and cryptographically
	 * protected against tampering by, the client. The attestation object contains
	 * both authenticator data and an attestation statement.
	 */
	...
	/**
	 * Represents the DER-encoded SubjectPublicKeyInfo structure associated with the
	 * new credential.
	 * <p>
	 * This field contains the cryptographic representation of the public key used
	 * by the new credential, encoded in DER format according to X.509 standards.
	 * The SubjectPublicKeyInfo structure encapsulates essential details about the
	 * public key, including the algorithm type, parameters, and the key itself.
	 * <p>
	 * Accessing this field allows for cryptographic operations, such as signature
	 * verification and authentication, within the WebAuthn. It serves as a crucial
	 * component in validating the authenticity and integrity of credentials during
	 * authentication processes.
	 */
	private String publicKey;

	/**
	 * Retrieves the JSON-compatible serialization of client data passed to the
	 * authenticator.
	 *
	...
	/**
	 * Sets the JSON-compatible serialization of client data passed to the
	 * authenticator.
	 *
	...
	/**
	 * Retrieves the attestation object containing authenticator data and an
	...
	/**
	 * Sets the attestation object containing authenticator data and an attestation
	 * statement.
	 *
	...
	/**
	 * Retrieves the DER-encoded SubjectPublicKeyInfo structure associated with the
	 * new credential.
	 *
	...
	/**
	 * Sets the DER-encoded SubjectPublicKeyInfo structure associated with the new
	 * credential.
	 *
