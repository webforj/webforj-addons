 ...
 *
 * <p>Authenticator Selection Criteria is used to specify requirements for authenticator attributes
...
public class AuthenticatorSelectionCriteria {
   ...
   *
   * <p>The {@code authenticatorAttachment} attribute, if present, filters eligible authenticators
   * to only those attached with the specified modality, as defined in the <a href=
   * "https://www.w3.org/TR/webauthn-3/#enum-attachment"> Authenticator Attachment Enumeration</a>.
   */
   ...
   *
   * <p>The {@code residentKey} attribute specifies the extent to which the Relying Party desires to
   ...
   *
   * <p>For backwards compatibility with WebAuthn Level 1, when this attribute is set to {@link
   * ResidentKeyRequirement#REQUIRED}, the {@code requireResidentKey} member is emitted and set to
   * {@code true}. Otherwise, it is emitted and set to {@code false}.
   */
   ...
   *
   * <p>This attribute is automatically set based on the {@link
   * AuthenticatorSelectionCriteria#residentKey} attribute. If {@link
   * AuthenticatorSelectionCriteria#residentKey} is set to {@link ResidentKeyRequirement#REQUIRED},
   * {@code requireResidentKey} will be {@code true}; otherwise, it will be {@code false}.
   */
   ...
   *
   * <p>The {@code userVerification} attribute describes the Relying Party's requirements for user
