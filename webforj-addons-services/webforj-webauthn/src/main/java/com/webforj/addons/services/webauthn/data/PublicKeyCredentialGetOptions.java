 ...
 *
 * @see <a href=
 *     "https://www.w3.org/TR/webauthn-3/#dictdef-publickeycredentialcreationoptions">§5.4. Options
 *     for Credential Creation (dictionary PublicKeyCredentialGetOptions)</a>
 * @author @ElyasSalar
 * @since 1.00
 */
public class PublicKeyCredentialGetOptions {
  ...
  /**
   * Describes the relying party's requirements regarding user verification for the {@code
   * navigator.credentials.get()} operation. Eligible authenticators are filtered based on this
   * requirement. If not set, the default in the browser is {@link
