...
/**
 * Represents the response returned by the {@code navigator.credentials.get()}
 * function. This class encapsulates the data returned from the client-side
 * authentication process.
 *
 * @see <a href=
 *      "https://www.w3.org/TR/webauthn-3/#ref-for-dictdef-authenticationresponsejson">§5.5.
...
public class AuthenticationResponse {
	/**
	 * The identifier of the returned credential, which is chosen by the
	 * authenticator. This identifier is used to look up credentials for use and is
	 * expected to be globally unique with high probability across all credentials
	 * of the same type and across all authenticators.
	 */
	private String id;

	/**
	 * The raw identifier of the returned credential. This identifier is used
	 * internally and is typically an encoded version of the ID.
	 */
	private String rawId;

	/**
	 * The response object containing data returned by the authenticator during the
	 * assertion process.
	 */
	private AuthenticatorAssertionResponse response;

	/**
	 * The attachment modality of the authenticator during the assertion process, if
	 * applicable.
	 */
	 ...
	 * upon the invocation of {@code navigator.credentials.get()}.
	 */
	private AuthenticationExtensionsOutput clientExtensionResults;

	/**
	 * The type of the credential. For WebAuthn, this will typically be
	 * "public-key".
	 */
	private String type;

	/**
	 * Converts this {@code AuthenticationResponse} instance to its JSON
	 * representation.
	 *
