...
/**
 * Represents the registration options for a WebAuthn operation, as defined in
 * the WebAuthn specification version 3. This class allows specifying extensions
 * to be used during credential creation or authentication.
 *
 * @see <a href=
...
public class AuthenticationExtensionsInput {
	 ...
	 * @param credProps A boolean indicating whether the client requests the
	 *            authenticator's credential properties extension.
	 * @param hmacCreateSecret A boolean indicating whether the client requests a
	 *            newly generated HMAC-Secret extension input.
	 */
	public AuthenticationExtensionsInput(String appid, boolean credProps,
	...
	/**
	 * Checks if the client requests the authenticator's credential properties
	 * extension.
	 *
	...
	/**
	 * Sets whether the client requests the authenticator's credential properties
	 * extension.
	 *
	...
	/**
	 * Sets whether the client requests a newly generated HMAC-Secret extension
	 * input.
	 *
	 * @param hmacCreateSecret The value indicating if the extension input is
	 *            requested.
	 */
