 ...
 * of transport hints from some attestation statement formats or via some
...
public enum AuthenticatorTransport {
	/**
	 * Indicates the respective authenticator can be contacted over Bluetooth Low
	 * Energy (BLE).
	 *
	 * @see <a href=
	...
	/**
	 * Indicates the respective authenticator can be contacted over Universal Serial
	 * Bus (USB).
	 *
	 * @see <a href=
