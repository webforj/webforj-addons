...
public final class ByteArray {
   ...
   * <p>
   * This method takes a byte array containing decoded binary data and converts it to a UTF-8
   ...
   *         decodedBytes parameter is null, indicating that no binary data is provided for
   *         conversion.
   */
