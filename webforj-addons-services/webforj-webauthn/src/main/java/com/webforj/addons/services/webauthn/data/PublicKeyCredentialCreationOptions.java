...
public class PublicKeyCredentialCreationOptions {
   ...
   *
   * <p>
   * The {@code rp} field contains data about the Relying Party, including its name and unique
   * identifier. It identifies the entity initiating the authentication process. For further
   * details, refer to {@code RelyingPartyIdentity}.
   * </p>
   */
   ...
   *
   * <p>
   * The {@code user} field holds information regarding the user account, such as username, display
   * name, and user handle. It provides essential data for linking public key credentials with the
   * user's identity.
   * </p>
   */
  ...
  /**
   * A challenge used for generating the attestation object of the newly created credential.
   *
   * <p>
   * The {@code challenge} field represents a cryptographic challenge intended to prevent replay
   * attacks during the credential creation process. Refer to the
   * <a href="https://www.w3.org/TR/webauthn-3/#sctn-cryptographic-challenges"> §13.1 Cryptographic
   * Challenges</a> security consideration for further information.
   * </p>
   */
   ...
   *
   * <p>
   * The {@code pubKeyCredParams} field specifies the desired characteristics of the credential,
   * such as cryptographic algorithms and key types. It represents a sequence ordered from most
   * preferred to least preferred, allowing the client to make the best effort in creating the most
   * preferred credential possible.
   * </p>
   */
  private List<PublicKeyCredentialParameters> pubKeyCredParams =
      List.of(new PublicKeyCredentialParameters(COSEAlgorithmIdentifier.EdDSA),
  ...
  /**
   * Indicates the maximum time, in milliseconds, that the caller is willing to wait for the
   * operation to complete.
   *
   * <p>
   * The {@code timeout} field serves as a hint, suggesting the maximum duration for the credential
   * creation operation.
   * </p>
   */
   ...
   *
   * <p>
   * The {@code excludeCredentials} field contains a set of public key credentials that the Relying
   * Party excludes from use during credential creation. It helps prevent the creation of multiple
  ...
  /**
   * Defines criteria for selecting authenticators to participate in the operation.
   *
   * <p>
   * The {@code authenticatorSelection} field specifies preferences for authenticator selection,
   * including factors such as attachment modality and user verification requirement.
   * </p>
   */
   ...
   *
   * <p>
   * The {@code attestation} field expresses the Relying Party's preference regarding the conveyance
   * of attestation during credential creation.
   * </p>
   */
   ...
   *
   * <p>
   * The {@code extensions} field offers additional input data for authentication extensions used
   * during credential creation. It allows for customization and extension of the credential
   * creation process with domain-specific functionality. For a list of registered WebAuthn
   * Extensions, consult the IANA "WebAuthn Extension Identifier" registry.
   * </p>
   */
  ...
  /**
   * Converts this {@code PublicKeyCredentialCreationOptions} instance to its JSON representation.
   *
   * @return JSON representation of this {@code PublicKeyCredentialCreationOptions}.
   */
  ...
  /**
   * Converts a JSON string to a {@code PublicKeyCredentialCreationOptions} instance.
   *
   * @param json JSON string representing {@code PublicKeyCredentialCreationOptions}.
   ...
   */
  public static PublicKeyCredentialCreationOptions fromJson(String json) throws JsonParseException {
    Gson gson = new GsonBuilder().create();
    return gson.fromJson(json, PublicKeyCredentialCreationOptions.class);
  }

  /**
   * Retrieves information about the Relying Party (RP) responsible for the request.
   *
  ...
  /**
   * Retrieves the challenge used for generating the attestation object of the newly created
   * credential.
   *
  ...
  /**
   * Retrieves the maximum time, in milliseconds, that the caller is willing to wait for the
   * operation to complete.
   *
  ...
  /**
   * Sets the maximum time, in milliseconds, that the caller is willing to wait for the operation to
   * complete.
   *
  ...
  /**
   * Retrieves the criteria for selecting authenticators to participate in the operation.
   *
  ...
  /**
   * Sets the criteria for selecting authenticators to participate in the operation.
   *
