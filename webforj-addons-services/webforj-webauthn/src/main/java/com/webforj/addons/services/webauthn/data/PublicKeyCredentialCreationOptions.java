...
public class PublicKeyCredentialCreationOptions {
   ...
   *
   * <p>The {@code rp} field contains data about the Relying Party, including its name and unique
   ...
   *
   * <p>The {@code user} field holds information regarding the user account, such as username,
   * display name, and user handle. It provides essential data for linking public key credentials
   ...
   *
   * <p>The {@code challenge} field represents a cryptographic challenge intended to prevent replay
   * attacks during the credential creation process. Refer to the <a href=
   * "https://www.w3.org/TR/webauthn-3/#sctn-cryptographic-challenges"> §13.1 Cryptographic
   ...
   *
   * <p>The {@code pubKeyCredParams} field specifies the desired characteristics of the credential,
   ...
   *
   * <p>The {@code timeout} field serves as a hint, suggesting the maximum duration for the
   ...
   *
   * <p>The {@code excludeCredentials} field contains a set of public key credentials that the
   * Relying Party excludes from use during credential creation. It helps prevent the creation of
   ...
   *
   * <p>The {@code authenticatorSelection} field specifies preferences for authenticator selection,
   ...
   *
   * <p>The {@code attestation} field expresses the Relying Party's preference regarding the
   * conveyance of attestation during credential creation.
   */
   ...
   *
   * <p>The {@code extensions} field offers additional input data for authentication extensions used
