...
/**
 * This class represents the client data passed to
 * {@code navigator.credentials.create()} or
 * {@code navigator.credentials.get()}. It contains information such as the
 * cryptographic challenge, origin, cross-origin status, token binding, and type
 * of operation. This class is part of the Web Authentication (WebAuthn) Level 3
 * specification.
 *
 * @see <a href=
 *      "https://www.w3.org/TR/webauthn-3/#dom-authenticatorresponse-clientdatajson">Web
...
public class ClientDataJSON {
	...
	/**
	 * The base64url-encoded version of the cryptographic challenge sent from the
	...
	/**
	 * Indicates whether the calling context is an <iframe> that is not same origin
	 * with its ancestor frames.
	 */
	private boolean crossOrigin;

	/**
	 * Contains the fully qualified top-level origin of the relying party. This
	 * property is set only if {@code crossOrigin} is {@code true}.
	 */
	private String topOrigin;

	/**
	 * Describes the state of the token binding protocol for communication with the
	 * relying party. It consists of two properties: {@code status} and {@code id}.
	 */
	...
	/**
	 * Gets the base64url-encoded version of the cryptographic challenge sent from
	...
	/**
	 * Checks whether the calling context is an <iframe> that is not same origin
	 * with its ancestor frames.
	 *
	...
	/**
	 * Gets the fully qualified top-level origin of the relying party. This property
	 * is set only if {@code crossOrigin} is {@code true}.
	 *
