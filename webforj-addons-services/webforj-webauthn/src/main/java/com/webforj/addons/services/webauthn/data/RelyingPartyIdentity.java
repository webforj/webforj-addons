...
/**
 * Represents additional attributes of the Relying Party when creating a new
 * credential.
 *
 * <p>
 * {@code RelyingPartyIdentity} provides supplementary information about the
 * Relying Party during the process of creating a new credential. It includes
 * attributes such as the name and unique identifier of the Relying Party.
 * </p>
 *
 * @see <a href=
 *      "https://www.w3.org/TR/webauthn-3/#dictdef-publickeycredentialrpentity">
 *      §5.4.2. Relying Party Parameters for Credential Generation (dictionary
...
public class RelyingPartyIdentity {
	 ...
	 *
	 * <p>
	 * The {@code name} field represents the human-readable name of the Relying
	 * Party. It typically identifies the organization or entity responsible for
	 * authentication.
	 * </p>
	 */
	 ...
	 *
	 * <p>
	 * The {@code id} field serves as a unique identifier for the Relying Party. It
	 * defines the scope where users' credentials are valid, ensuring authentication
