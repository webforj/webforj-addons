 ...
 *
 * <p>{@code RelyingPartyIdentity} provides supplementary information about the Relying Party during
...
public class RelyingPartyIdentity {
   ...
   *
   * <p>The {@code name} field represents the human-readable name of the Relying Party. It typically
   ...
   *
   * <p>The {@code id} field serves as a unique identifier for the Relying Party. It defines the
   * scope where users' credentials are valid, ensuring authentication within specific domains.
   *
