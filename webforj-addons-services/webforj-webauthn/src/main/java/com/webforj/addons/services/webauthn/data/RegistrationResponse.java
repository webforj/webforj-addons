 ...
 *
 * <p>This class simplifies working with ArrayBuffers that are Base64URL-encoded in the browser,
 * allowing them to be sent as JSON to the server.
 *
 * @see <a href=
...
public class RegistrationResponse {
  ...
  /**
   * The raw identifier of the credential returned by the authenticator, encoded as a URL-safe
   * base64 string.
   */
