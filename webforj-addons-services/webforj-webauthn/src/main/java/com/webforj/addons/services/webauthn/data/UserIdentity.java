 ...
 *
 * <p>
 * This class encapsulates user account information required for creating public key credentials,
...
public class UserIdentity {
   ...
   *
   * <p>
   * The {@code name} field stores a human-readable identifier associated with the user account. It
   * serves as a unique identifier but is primarily intended for internal use and not for display
   * purposes.
   * </p>
   */
   ...
   *
   * <p>
   * The {@code displayName} field holds a user-friendly name intended for display purposes. It is
   * typically used to represent the user's name or a recognizable alias in user interfaces.
   * </p>
   */
   ...
   *
   * <p>
   * The {@code id} field contains a unique identifier, known as the user handle, associated with
