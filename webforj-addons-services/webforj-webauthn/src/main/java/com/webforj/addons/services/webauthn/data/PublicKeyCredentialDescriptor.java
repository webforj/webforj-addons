 ...
 * credential as an input parameter to the {@code navigator.credentials.create()} or {@code
 * navigator.credentials.get()} methods. It mirrors the fields of the PublicKeyCredential object
 * returned by the latter methods.
 *
 * <p>The {@code PublicKeyCredentialDescriptor} object is used to describe the credentials to be
 * used or retrieved. It includes the type of the credential, the credential ID, and an optional
 * hint as to how the client might communicate with the managing authenticator of the public key
 * credential.
 *
...
public class PublicKeyCredentialDescriptor {
   ...
   *
   * <p>This should be stored along with the ID and used unmodified whenever creating a {@code
